...
@Component({
  selector: "app-view-my-student",
  templateUrl: "./view-my-student.page.html",
  styleUrls: ["./view-my-student.page.scss"]
})
export class ViewMyStudentPage implements OnInit {
  ...
  ionViewWillEnter() {
    this.userData$.subscribe((user: any) => {
      ...
      this.userService.getUser(user.student[0]).subscribe((stud: any) => {
        ...
        if (stud) {
          this.classService
            .getClassByStudentId(user.student[0])
